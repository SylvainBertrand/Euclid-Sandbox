...
public class EPAConvexPolytope3D implements ConvexPolytope3DReadOnly, Shape3DBasics
{
   ...
   {
      if (face == null || !facesToPack.add(face))
         return;

      EPAHalfEdge3D e0 = face.getEdge0();
      EPAHalfEdge3D e1 = face.getEdge1();
      EPAHalfEdge3D e2 = face.getEdge2();
      if (e0 != null)
      {
         EPAHalfEdge3D t0 = e0.getTwin();
         if (t0 != null)
            collectFacesRecursively(t0.getFace(), facesToPack);
      }
      if (e1 != null)
      {
         EPAHalfEdge3D t1 = e1.getTwin();
         if (t1 != null)
            collectFacesRecursively(t1.getFace(), facesToPack);
      }
      if (e2 != null)
      {
         EPAHalfEdge3D t2 = e2.getTwin();
         if (t2 != null)
            collectFacesRecursively(t2.getFace(), facesToPack);
      }
   }
